                ...
                .andDo(
                        document("recruiting-create",
                                requestFields(
                                        ...
                                        fieldWithPath("personalityAdjectives").description("선호하는 성향 형용사"),
                                        fieldWithPath("personalityNouns").description("선호하는 성향 명사"),
                ...
                .andDo(
                        document("recruiting-detail",
                                responseFields(
                                        ...
                                        fieldWithPath("recruitingMemberCount").description("모집 인원"),
                                        fieldWithPath("activityArea").description("활동 지역"),
                                        fieldWithPath("personalities").description("배열 형태의 선호하는 성향"),
                                        fieldWithPath("personalities[].adjective").description("선호하는 성향 형용사"),
                                        fieldWithPath("personalities[].noun").description("선호하는 성향 명사"),
