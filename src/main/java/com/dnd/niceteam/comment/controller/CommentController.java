...
public class CommentController {
    ...
    @PostMapping
    public ResponseEntity<ApiResult<CommentCreation.ResponseDto>> commentAdd(@PathVariable Long recruitingId, @RequestBody @Valid CommentCreation.RequestDto commentDto) {
